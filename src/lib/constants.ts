import GithubLogo from '@src/assets/images/Github_logo.png'
import SpotifyLogo from '@src/assets/images/Spotify_logo.png'
import SteamLogo from '@src/assets/images/Steam_logo.png'
import AnilistLogo from '@src/assets/images/AniList_logo.svg'

// #region ShowList
export const appShowList = [
  {
    appName: 'GitHub',
    appDescription:
...
export const showListTitle = 'Lo que me define'

export const showListDescription =
  ' Estas son las ventanas a mi mundo digital: playlists que marcan mis días, partidas que me retan, animes que me inspiran y proyectos que reflejan mi crecimiento como desarrollador. Cada uno cuenta una parte de mi historia.'

// #region HeaderVideo

export const headerTitle = 'Mi universo digital'
export const headerText =
  'Aquí convergen mis pasiones: el ritmo de mi música, los mundos que exploro en mis juegos, las historias que sigo en anime, y el código que construye mi camino. Todo, en un solo lugar.'

// #region About me

export const aboutMeTitle = 'Un poco acerca de mí'
