import { type ImageHeaderProps } from '@src/types/TYPES'
import SeparatorImage from '@src/assets/images/Separator.gif'
import { useEffect, useState } from 'react'

const ImageHeader = ({ image, title, text }: ImageHeaderProps) => {
  ...
  return (
    <header className="flex w-full h-screen justify-center items-center relative overflow-hidden mb-10">
      <img src={image} alt={title} className="absolute z-0 object-cover w-full h-full" />
